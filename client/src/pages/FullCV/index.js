    ...
    <>
      ...
      <div className="row justify-content-center">
        ...
        <div className="accordion" id="accordionExample">
          <Collapse image={<img src={twoU} alt="2U" style={{ height: "50px" }} />} idNum={"One"}>
          ...
          <Collapse image={<img src={harvard} alt="Harvard University" style={{ height: "50px" }} />} idNum={"Two"}>
            <strong>Full-Stack Web Developer</strong>
            <li>
              Completed a six-month full-stack coding bootcamp implementing web development tools and practices such as VS Code, GitHub, Postman, React, MySQL and MongoDB as well as version control and code reviews for both independent and team-based projects.
            </li>
          </Collapse>
          <Collapse image={<img src={glytec} alt="Glytec" style={{ height: "50px" }} />} idNum={"Three"}>
          ...
          <Collapse image={<img src={athena} alt="athenahealth" style={{ height: "50px" }} />} idNum={"Four"}>
            ...
            <li>
              ...
              connectivity consulting to partner systems on over 60 escalated
              connectivity, cron job and system networking issues.{" "}
            </li>
            <li>
              Addressed Single Sign-On and Connectivity product and process gaps
              by implementing a mixed methods Scrum & Kanban framework in JIRA
              resulting in the completion of 115 user stories executed across 18
              sprints in 2018.
            </li>
            <li>
            ...
            <li>
              Built over 150 integrations involving solutions scoping, message
              format analysis, interface engine build, product enhancements,
              connectivity troubleshooting, unit testing, Production deployment
              and Go-Live coordination.
            </li>
            <li>
              Managed the business operations of a team of 18 Offshore Partner
              Integration Engineers through process creation, feedback cycles,
              escalation management, technical mentorship, training, and product
              documentation.
            </li>
            <li>
          ...
          <Collapse image={<img src={usds} alt="US Department of State" style={{ height: "50px" }} />} imageTwo={<img src={usds2} alt="US Department of State" style={{ height: "25px" }} />} idNum={"Five"}>
          ...
          <Collapse image={<img src={scheck} alt="Scheck Hillel Community School" style={{ height: "50px" }} />} idNum={"Six"}>
            <strong>Standardized Test Instructor</strong>
            <li>
              Supported the ACT and SAT exam preparation for over 167 students
              by conducting lectures with class sizes of up to 17 students as
              well as providing college application readiness and tutoring
              services.
            </li>
          </Collapse>
          <Collapse image={<img src={usc} alt="University of Southern California" style={{ height: "50px" }} />} idNum={"Seven"}>
            ...
            <li>
              Created visualizations of math policy structures and standardized
              test policies for the LACCD school district.
            </li>
            <br />
